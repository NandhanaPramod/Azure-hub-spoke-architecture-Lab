...
vnet_cidr = ["10.50.16.0/22", "10.50.30.0/23", "10.50.38.0/23"]
...
vnet_subnets = [
  {
    name              = "spare"
    address_prefixes  = ["10.50.16.0/26"]
  ...
  {
    name              = "web"
    address_prefixes  = ["10.50.16.64/26"]
    security_group    = "web"
  ...
  {
    name              = "api"
    address_prefixes  = ["10.50.16.128/26"]
    security_group    = "api"
  ...
  {
    name              = "database"
    address_prefixes  = ["10.50.16.192/26"]
  ...
  },
  {
    ...
    address_prefixes  = ["10.50.38.0/23"]
    security_group    = "application"
    service_endpoints = ["Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Sql", "Microsoft.Storage"]
    route_table       = "routing"
  },
  {
    ...
    address_prefixes  = ["10.50.30.0/23"]
    security_group    = "application"
    service_endpoints = ["Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Sql", "Microsoft.Storage"]
    route_table       = "routing"
  },
