...
vnet_cidr = ["10.50.12.0/22", "10.50.28.0/23", "10.50.36.0/23"]
...
vnet_subnets = [
  {
    name              = "spare"
    address_prefixes  = ["10.50.12.0/26"]
  ...
  {
    name              = "web"
    address_prefixes  = ["10.50.12.64/26"]
    security_group    = "web"
  ...
  {
    name              = "api"
    address_prefixes  = ["10.50.12.128/26"]
    security_group    = "api"
  ...
  {
    name              = "database"
    address_prefixes  = ["10.50.12.192/26"]
  ...
  {
    name              = "application"
    address_prefixes  = ["10.50.13.0/24"]
    security_group    = "application"
    service_endpoints = ["Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Sql", "Microsoft.Storage"]
    route_table       = "routing"
  },
  {
    name              = "application_blue"
    address_prefixes  = ["10.50.36.0/23"]
    security_group    = "application"
    service_endpoints = ["Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Sql", "Microsoft.Storage"]
    route_table       = "routing"
  },
  {
    name              = "dhp_application"
    address_prefixes  = ["10.50.28.0/23"]
    security_group    = "application"
    service_endpoints = ["Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Sql", "Microsoft.Storage"]
    route_table       = "routing"
  },
  {
    name              = "azureapps"
    address_prefixes  = ["10.50.14.0/26"]
