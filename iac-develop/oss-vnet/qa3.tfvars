...
vnet_cidr = ["10.50.24.0/22", "10.50.34.0/23"]
...
vnet_subnets = [
  {
    name              = "spare"
    address_prefixes  = ["10.50.24.0/26"]
  ...
  {
    name              = "web"
    address_prefixes  = ["10.50.24.64/26"]
    security_group    = "web"
  ...
  {
    name              = "api"
    address_prefixes  = ["10.50.24.128/26"]
    security_group    = "api"
  ...
  {
    name              = "database"
    address_prefixes  = ["10.50.24.192/26"]
  ...
  {
    name              = "application"
    address_prefixes  = ["10.50.26.0/23"]
  ...
  },
  {
    ...
    address_prefixes  = ["10.50.34.0/23"]
    security_group    = "application"
    service_endpoints = ["Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Sql", "Microsoft.Storage"]
    route_table       = "routing"
  },
  {
    name              = "azureapps"
    address_prefixes  = ["10.50.25.0/25"]
